...
namespace Storefront.UI.MVC.Controllers
{
    public class UserDetailsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserId,FirstName,LastName,Email,Address,PhoneNumber")] UserDetail userDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("UserId,FirstName,LastName,Email,Address,PhoneNumber")] UserDetail userDetail)
        {
